...
const CURRICULUM_B1 = [
  ...
  /* ── A1 ─────────────────────────────────────────────────────────── */
  {
    ...
    words:[
      ...
      {en:'good morning', fr:'bonjour (matin)',   es:'buenos días',   esTarget:'buenos días',example:{fr:'Bonjour tout le monde !',      es:'¡Buenos días a todos!'}},
...

  {
    ...
    words:[
      ...
      {en:'eye',    fr:'œil',     es:'ojo',     esTarget:'ojos',    example:{fr:'Elle a les yeux verts.', es:'Tiene los ojos verdes.'}},
      {en:'hair',   fr:'cheveux', es:'pelo',    esTarget:'pelo',    example:{fr:'Ses cheveux sont longs.',es:'Su pelo es largo.'}},
      {en:'hand',   fr:'main',    es:'mano',    esTarget:'manos',   example:{fr:'Lave tes mains.',       es:'Lavate las manos.'}},
      {en:'foot',   fr:'pied',    es:'pie',     esTarget:'pies',    example:{fr:'Mes pieds sont fatigués.', es:'Mis pies están cansados.'}},
    ],
  },
...

  {
    ...
    words:[
      ...
      {en:'hungry',    fr:'affamé',       es:'hambriento',  esTarget:'hambre',      example:{fr:'J\'ai très faim.',              es:'Tengo mucha hambre.'}},
      {en:'thirsty',   fr:'assoiffé',     es:'sediento',    esTarget:'sed',         example:{fr:'J\'ai soif.',                   es:'Tengo sed.'}},
    ],
  },
  ...
  /* ── A2 ─────────────────────────────────────────────────────────── */
  {
    ...
    grammar:{
      title:'Passé récent — Pretérito perfecto compuesto',
      note:'he/has/ha + participe : He tomado el subte (j\'ai pris le métro). Utilisé pour des actions récentes encore liées au présent. Participes : -ar → -ado, -er/-ir → -ido.',
      examples:[
        {fr:'J\'ai pris le bus ce matin.',   es:'He tomado el colectivo esta mañana.'},
        {fr:'Est-ce que tu as vu le train?', es:'¿Has visto el tren?'},
      ],
      question:'Quel est le participe passé de "viajar" ?',
...

  {
    ...
    words:[
      ...
      {en:'cloud',        fr:'nuage',       es:'nube',        esTarget:'nubes',       example:{fr:'Des nuages sombres.',     es:'Nubes oscuras.'}},
...

  {
    ...
    words:[
      ...
      {en:'to sell',   fr:'vendre',     es:'vender',   esTarget:'venden',   example:{fr:'Ils vendent des fruits.', es:'Venden frutas.'}},
...

  {
    ...
    words:[
      ...
      {en:'headache',     fr:'mal de tête',es:'dolor de cabeza',esTarget:'cabeza',   example:{fr:'J\'ai mal à la tête.',      es:'Me duele la cabeza.'}},
      ...
      {en:'to hurt',      fr:'faire mal',  es:'doler',       esTarget:'duele',       example:{fr:'Ça fait mal.',              es:'Duele.'}},
...

  {
    ...
    words:[
      {en:'to cook',    fr:'cuisiner',    es:'cocinar',    esTarget:'cocinás',  example:{fr:'Tu cuisines bien.',      es:'Cocinás muy bien.'}},
      ...
      {en:'to cut',     fr:'couper',      es:'cortar',     esTarget:'cortá',    example:{fr:'Coupe le pain.',         es:'Cortá el pan.'}},
      {en:'to mix',     fr:'mélanger',    es:'mezclar',    esTarget:'mezclá',   example:{fr:'Mélange tout.',          es:'Mezclá todo.'}},
      {en:'to boil',    fr:'faire bouillir',es:'hervir',   esTarget:'hervir',   example:{fr:'Fais bouillir l\'eau.',  es:'Hacé hervir el agua.'}},
      {en:'to taste',   fr:'goûter',      es:'probar',     esTarget:'probá',    example:{fr:'Goûte et dis-moi.',      es:'Probá y decime.'}},
...

  {
    ...
    words:[
      ...
      {en:'download',   fr:'télécharger',es:'descargar',  esTarget:'descargá',  example:{fr:'Télécharge l\'app.',         es:'Descargá la app.'}},
...

  {
    ...
    words:[
      ...
      {en:'running',    fr:'courir',      es:'correr',          esTarget:'corrés',       example:{fr:'Tu cours chaque matin ?',   es:'¿Corrés cada mañana?'}},
      {en:'to win',     fr:'gagner',      es:'ganar',           esTarget:'ganamos',      example:{fr:'On a gagné !',              es:'¡Ganamos!'}},
      {en:'to lose',    fr:'perdre',      es:'perder',          esTarget:'perdimos',     example:{fr:'On a perdu.',               es:'Perdimos.'}},
...

  {
    ...
    grammar:{
      ...
      examples:[
        ...
        {fr:'Je veux que tu m\'aides.',      es:'Quiero que me ayudés.'},
      ],
    ...
    words:[
      ...
      {en:'to promise', fr:'promettre',   es:'prometer',  esTarget:'prometé',   example:{fr:'Promets-moi.',            es:'Prometeme.'}},
      {en:'to forgive', fr:'pardonner',   es:'perdonar',  esTarget:'perdoná',   example:{fr:'Pardonne-moi.',           es:'Perdoname.'}},
      {en:'to argue',   fr:'se disputer', es:'discutir',  esTarget:'discutir',  example:{fr:'On n\'argumente pas.',    es:'No discutamos.'}},
  ...
  /* ── B1 ─────────────────────────────────────────────────────────── */
  {
    ...
    words:[
      ...
      {en:'forest',       fr:'forêt',        es:'bosque',        esTarget:'bosque',        example:{fr:'Le bosque est protégé.',       es:'El bosque está protegido.'}},
...

  {
    ...
    dialogue:{
      ...
      lines:[
        ...
        {es:'— Sí, fue filmada un documental sobre él también.', fr:'— Oui, un documentaire a aussi été tourné sur lui.'},
...

  {
    ...
    dialogue:{
      note:'"A mi me parece que" (à mon avis) et "no estoy de acuerdo" (je ne suis pas d\'accord) sont essentiels pour tout débat.',
      lines:[
        {es:'— A mi me parece que hay demasiada desigualdad.', fr:'— À mon avis il y a trop d\'inégalité.'},
    ...
    grammar:{
      ...
      note:'A mi modo de ver / A mi me parece (à mon avis). Sin embargo (cependant). Aunque (bien que/même si). Por un lado… por otro (d\'un côté… de l\'autre). Hay que reconocer que (il faut reconnaître que).',
      examples:[
    ...
    phrase:{fr:'À mon avis, c\'est important.', es:'A mi me parece que es importante.'},
    words:[
      {en:'to agree',      fr:'être d\'accord',        es:'estar de acuerdo',    esTarget:'de acuerdo',    example:{fr:'Je suis d\'accord.',          es:'Estoy de acuerdo.'}},
      {en:'to disagree',   fr:'ne pas être d\'accord', es:'no estar de acuerdo', esTarget:'no de acuerdo', example:{fr:'Je ne suis pas d\'accord.',    es:'No estoy de acuerdo.'}},
...

  {
    ...
    words:[
      {en:'inequality',  fr:'inégalité',   es:'desigualdad', esTarget:'desigualdad', example:{fr:'La inégalité augmente.',      es:'La desigualdad aumenta.'}},
...

  {
    ...
    words:[
      ...
      {en:'to heal',    fr:'guérir',     es:'sanar',      esTarget:'sanar',      example:{fr:'Il faut du temps pour guérir.', es:'Hay que tiempo para sanar.'}},
...

  {
    ...
    words:[
      ...
      {en:'fake news',    fr:'fake news',   es:'noticia falsa',esTarget:'falsa',      example:{fr:'C\'est une fake news.',      es:'Es una noticia falsa.'}},
